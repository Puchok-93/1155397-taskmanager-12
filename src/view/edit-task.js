...
const createTaskEditTemplate = (data) => {
  ...
  return `<article class="card card--edit card--${color} ${color} ${repeatingClassName}">
...
export default class TaskEdit extends Smart {
  ...
  /* Навешиваем обработчики повторно */
  ...
  /* Навешиваем обработчики на элементы управления задачами */
